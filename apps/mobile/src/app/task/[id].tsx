...
const styles = StyleSheet.create({
  ...
  decisionChecks: { ...type.labelSm, color: palette.citronText },
  ...
  timelineHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, minHeight: hitTarget },
  timelineCount: { ...type.labelSm, color: palette.mutedDeep, flex: 1, textAlign: 'right' },
